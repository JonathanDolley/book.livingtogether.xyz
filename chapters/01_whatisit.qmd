...
![The Hansalim Manifesto, English version](../images/chapter_01/Hansalim-Manifesto.jpeg){width="30%" fig-align="left"}
...
The chart below gives you an idea of the amount of interaction between consumers and producers in the course of a single year.
...
![Figure 3. Participation in 2023: engagement among consumers and exchanges between consumers and producers](../plots/Participation_2023.png){group="diagrams"}
...
![Figure 4. Hansalim's many organisations and their relationships](../diagrams/federation.png){group="diagrams"}
...
The way the Hansalim Federation sees itself in relation to the other Hansalim organisations can be understood with the help of the following diagram which was published in the Hansalim 2017 White Paper.
I have reproduced it here with some minor modifications and translated it into English.

![Figure 5. A map of Hansalim stakeholders and their responsibilities](../diagrams/stakeholders.png){group="diagrams"}

Hansalim’s stakeholders include five categories: Producers, Cooperators (i.e. consumer members), Practitioners, Activists and the Local Community.
Along with Producers, the Cooperators share the main responsibility for governance of the federation and their local associations and Life Coops.
Cooperators are also expected to consume responsibly and participate in activities to support producers and help the local community.

The original role of Practitioners was to act as a bridge between producers and consumers while running the business activities.
...
As a consequence, the role of Practitioners as bridge between consumers and producers has become weaker and the emphasis has shifted towards running business operations.
...
Just look again at Figure 4 and notice the number of committee members in the column for Life Coops!
