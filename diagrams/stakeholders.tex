...
% Stakeholder Nodes
    ...
    \node [above,text width=5cm] at (activists.north) {\footnotesize{\begin{itemize}
        ...
        \end{itemize}}};    
    \node (members) [circle,color=white!100,fill=\ColGreen,minimum width=2cm,align=center] at (Clock-03) {\textbf{Members}\\\footnotesize{\textit{184 delegates}}};
    \node [below,text width=4cm] at (members.south) {\footnotesize{\begin{itemize}
